...
//       <h2 className="invoices-title text-center">Invoices</h2>
...
//                   </div>
//                 </div>
//                 <span className="status-badge text-center py-2 my-auto">
...
//                 <button
//                   className="pdf-btn rounded btn-primary border-0 p-2"
//                   onClick={() => generateInvoicePDF(inv)}
//                 >
//                   Download <FaFilePdf className="pdf-icon" />
//                 </button>

//                 <button
//                   className="delete-btn rounded btn-danger border-0 p-2"
          ...
          <table className="table table-hover align-middle text-center">
            <thead className="table-light">
              <tr>
                ...
                <th>Customer</th>
                <th>Total</th>
                <th className="text-end text-center">Actions</th>
              </tr>
            </thead>
            ...
            <tbody>
              {invoices.map((inv) => (
                <tr key={inv.id}>
                  ...
                  <td>{getEnumLabel("invoiceType", inv.type)}</td>

                  <td>{inv.customer?.name?.toUpperCase()}</td>
